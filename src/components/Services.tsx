        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="relative p-6 bg-black/80 backdrop-blur-sm border border-gray-800 rounded-lg hover:border-[var(--neon-blue)]/50 transition-all duration-300 h-full">
                <motion.div
                ...
                <div className="mt-4 flex items-center text-[var(--neon-blue)] text-sm font-medium opacity-0 group-hover:opacity-100 transition-opacity">
